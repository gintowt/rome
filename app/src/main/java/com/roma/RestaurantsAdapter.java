...
public class RestaurantsAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        RestaurantsAdapter.ViewHolder mainViewholder = null;
        if(convertView == null){
            LayoutInflater inflater = mContext.getLayoutInflater();
            convertView = inflater.inflate(R.layout.explore_list, parent, false);
            RestaurantsAdapter.ViewHolder viewHolder = new RestaurantsAdapter.ViewHolder();
            ...
            Picasso.get().load(restaurantsExplore.getImgUrl()).into(viewHolder.image);
            ...
            mainViewholder = (RestaurantsAdapter.ViewHolder) convertView.getTag();
