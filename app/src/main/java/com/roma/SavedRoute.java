...
public class SavedRoute extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attractionDbRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    if (position < (attractionList.size() - 1) ) {
                        ...
                        Toast.makeText(SavedRoute.this, "There is no more attractions to go to!", Toast.LENGTH_SHORT).show();
                    }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent back = new Intent(SavedRoute.this,  SavedActivity.class);
                startActivity(back);
    ...
    public void Findroutes(LatLng Start, LatLng End)
    {
        ...
        if(Start==null || End==null) {
            Toast.makeText(SavedRoute.this,"Unable to get location", Toast.LENGTH_LONG).show();
        }
        else
        {
...
//        Findroutes(start,end);
    ...
    public void onRoutingStart() {
        Toast.makeText(SavedRoute.this,"Finding Route...",Toast.LENGTH_LONG).show();
    }
    ...
    public LatLng getLocationFromAddress(String strAddress) {
        ...
        Geocoder coder = new Geocoder(SavedRoute.this, Locale.getDefault());
